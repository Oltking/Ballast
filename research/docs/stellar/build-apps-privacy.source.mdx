SOURCE: https://github.com/stellar/stellar-docs/blob/main/docs/build/apps/privacy.mdx
FETCHED: 2026-06-17T06:54:22Z
VERBATIM — NOT SUMMARIZED (git source .mdx, depth-1 clone of stellar/stellar-docs)
